package com.example.gd12_pdf_c_10852
...
import com.example.gd12_pdf_c_10852.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun createdPdf(
        ...
        val file = File(pdfPath, "pdf_10852.pdf")
        ...
        @SuppressLint("UseCompatLoadingForDrawables") val d = getDrawable(R.drawable.neon)
